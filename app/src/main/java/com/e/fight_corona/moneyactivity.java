...
public class moneyactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moneyactivity);

        button = findViewById(R.id.payButon);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String note = nameEt.getText().toString();
    ...
    private void payWithUPI(String amount, String note) {

        Uri uri = Uri.parse("upi://pay").buildUpon()
                .appendQueryParameter("pa", upiId)
                .appendQueryParameter("pn", nameOwner)
    ...
    public static boolean isConnectionAvailable(moneyactivity context) {
